...
class AsaasClient:
    def __init__(self, APIKey, sandbox=False) -> None:
        ...
        self._client_params = {
            ...
            "base_url": (APIBaseURL.SANDBOX if sandbox else APIBaseURL.PRODUCTION).value
        }
...
class AsaasResource:
    ...
    def get_list_response(self, response, data_response_class = dict) -> PaginatedOutputPayload:
